      ...
      <ul className="text-lg leading-relaxed space-y-8 mb-16 list-disc pl-6">
        <li>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>
              <span className="font-semibold pr-2">Backend:</span>
        ...
        <li>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>
              ...
              ESP32 + soil moisture + pump lockouts
            </li>
            <li>
              <span className="font-semibold pr-2">Gateway:</span>
              MQTT + FastAPI + local metrics
            </li>
            <li>
              <span className="font-semibold pr-2">UI:</span>
              live status, last water event, one-tap “water”
            </li>
          </ul>
        </li>
      </ul>
