      ...
      "
        >
            <section className={`text-[var(--TEXT_PRIMARY)] w-full pb-5 ${pad}`}>
                ...
                <p className={`text-xl mb-10 md:mb-24`}>
                ...
                <p className={`text-xl mb-8 md:mb-10`}>
                ...
                <p className={`text-xl mb-10 md:mb-24`}>
                    ...
                    form in
                    the physical world through embedded models, sensory feedback, and real-time decision-making. This
                    work
                    includes building machine learning transformation pipelines, training embedded models for vision,
                    text,
